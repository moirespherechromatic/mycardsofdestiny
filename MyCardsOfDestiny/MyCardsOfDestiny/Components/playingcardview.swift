...
struct PlayingCardView: View {
    ...
    var body: some View {
        Group {
            ...
            if let uiImage = loadCardImage() {
                ...
                // Fallback to text-based card if image not found
                textBasedCardView
            }
        }
    }
    ...
    private func loadCardImage() -> UIImage? {
        ...
        // Fourth try: Direct resource lookup
        ...
        // Log all available PNG files in bundle for debugging
