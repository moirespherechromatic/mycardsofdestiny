...
struct DailyCardView: View {
    ...
    var body: some View {
        ...
        .onAppear {
            // Mark as revealed when they open the daily card view
            // This way it's already updated when they navigate back
            dataManager.markDailyCardAsRevealed()
        }
        .onDisappear {
            // Mark the daily card as revealed when user leaves this view
            // This ensures they actually viewed the daily card before it's revealed on home
            dataManager.markDailyCardAsRevealed()
        }
    }
