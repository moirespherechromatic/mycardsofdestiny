...
// MARK: - Vintage Mystical Theme Definition (Black Version)
struct AppTheme {
    // Colors - Black Mystical Palette
    static let backgroundColor = Color(red: 0.86, green: 0.75, blue: 0.55) // Warm parchment #dbc08d
    static let cardBackground = Color(red: 0.95, green: 0.91, blue: 0.82) // Aged paper #f2e8d1
    static let darkAccent = Color.black // Pure black instead of brown
    static let shadowColor = Color.black.opacity(0.3) // Deeper black shadows
    static let primaryText = Color.black // Pure black text
    static let secondaryText = Color.black.opacity(0.7) // Semi-transparent black
    static let accentColor = Color.black.opacity(0.8) // Black accent
    static let goldAccent = Color(red: 0.83, green: 0.69, blue: 0.22) // Keep gold accent #d4af37
    
    // Typography - Custom Apothicaire Light Cd Font
    ...
    static let mysticalTitle = Font.custom("Apothicaire Light Cd", size: 28).weight(.heavy) // For main titles
    
    // Spacing - More elegant proportions
    static let paddingSmall: CGFloat = 8
    static let paddingMedium: CGFloat = 16
    static let paddingLarge: CGFloat = 24
    static let cornerRadius: CGFloat = 8 // Slightly less rounded for vintage feel
    
    // Shadows - More dramatic for vintage depth
...
// MARK: - Vintage Mystical View Modifiers
extension View {
    // Background styles
    ...
    // Typography styles - Vintage Serif
...
// MARK: - Vintage Mystical Button Styles
struct VintageButtonStyle: ButtonStyle {
    func makeBody(configuration: Configuration) -> some View {
        configuration.label
            ...
            .cornerRadius(25) // Rounded pill shape like the START button
