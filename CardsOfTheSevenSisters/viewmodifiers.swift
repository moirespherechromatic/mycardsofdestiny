...
struct DynamicTypeModifier: ViewModifier {
    ...
    func body(content: Content) -> some View {
        content
            .font(.custom("Apothicaire Light Cd",
                         size: scaledSize))
...
// MARK: - Card Animation Modifiers (Updated)
...
// MARK: - Navigation Modifiers (Updated)
        ...
        content
            ...
            .toolbar {
                ...
                ToolbarItem(placement: .principal) {
                    Text(title)
                        .font(.custom("Apothicaire Light Cd", size: scaledTitleSize))
                        .foregroundColor(.black)
                        .fontWeight(.heavy)
...
struct CardShadow: ViewModifier {
    ...
    private var shadowColor: Color {
        // Increase shadow opacity for high contrast mode
