...
struct ProfileSheet: View {
    ...
    private let appBackgroundColor = Color(red: 0.91, green: 0.82, blue: 0.63)
            ...
            ZStack {
                ...
                ScrollView {
                    VStack(spacing: 30) {
                        ...
                        // Legal Section - Privacy Policy Link
                        VStack(alignment: .leading, spacing: 15) {
                            ...
                            Button(action: {
                                if let url = URL(string: "https://mycardsofdestiny.com/privacy-policy") {
                            ...
                            Button(action: {
                                if let url = URL(string: "https://mycardsofdestiny.com/terms-of-service") {
                                    UIApplication.shared.open(url)
                                }
                            }) {
                                HStack {
